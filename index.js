...
function getRandomArbitrary(min, max) {
  ...
  function changeColor(node, counter, cost) {
    ...
    setTimeout(() => {
      node.style.backgroundColor = "#7F5283";
    }, counter * 100 + 100);
  } // End changeColor
  ...
  function start() {
    ...
    // Draw out best route
    setTimeout(() => {
      startNode.style.backgroundColor = "#ffff";
      while (endNode.getAttribute("parent") != "null") {
        endNode.style.backgroundColor = "#ffff";
  ...
  window.onload = () => {
    createBoard();
    document.querySelectorAll("button")[2].click();// selects the third button
  };